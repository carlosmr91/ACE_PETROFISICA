...
def configure_page():
    st.set_page_config(page_title="PETROFISICA ACE", layout="wide")
    st.markdown("<h1 style='text-align: center; color: black;'>ANÁLISIS PETROFÍSICO DE ACE</h1>", 
...
def plot_density_map(df,df_p, variable, polygon_lats, polygon_lons,color_continuous_scale,zoom):
    ...
    fig.update_layout(
        mapbox=dict(
            ...
            center=dict(lat=22.190, lon=-98.325),
            zoom=9.3,
        ),
